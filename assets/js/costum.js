...
function getVals() {
  ...
  let slides = parent.getElementsByClassName("slider_inputs");
...
function initializeSliders() {
  ...
  for (let x = 0; x < sliderSections.length; x++) {
    let sliders = sliderSections[x].getElementsByClassName("slider_inputs");
...
// Call the function directly without using window.onload
